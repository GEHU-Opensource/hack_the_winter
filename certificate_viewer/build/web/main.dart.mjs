...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1338: () => globalThis.name,
      _1339: () => globalThis.college,
      _1340: () => globalThis.team,
      _1341: () => globalThis.finalists,
      _1342: () => globalThis.position,
      _1343: (x0,x1) => x0.append(x1),
      _1344: x0 => ({type: x0}),
      _1345: (x0,x1) => new Blob(x0,x1),
      _1346: x0 => globalThis.URL.createObjectURL(x0),
      ...
      _1354: x0 => x0.click(),
      _1355: () => ({}),
      _1356: x0 => globalThis.pdfjsLib.getDocument(x0),
      _1357: (x0,x1) => x0.getContext(x1),
      _1358: (x0,x1) => x0.getPage(x1),
      _1359: (x0,x1) => x0.getViewport(x1),
      _1360: (x0,x1) => x0.render(x1),
      _1361: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1361(f,arguments.length,x0) }),
      _1362: (x0,x1) => x0.toBlob(x1),
      _1363: () => new FileReader(),
      _1364: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1365: x0 => x0.cleanup(),
      _1366: x0 => x0.destroy(),
      _1367: (x0,x1) => { x0.module = x1 },
      _1368: (x0,x1) => { x0.exports = x1 },
      _1376: Date.now,
      ...
      _1575: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1576: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1593: (x0,x1) => { x0.data = x1 },
      _1594: (x0,x1) => { x0.scale = x1 },
      _1595: (x0,x1) => { x0.canvasContext = x1 },
      _1596: (x0,x1) => { x0.viewport = x1 },
      _1597: (x0,x1) => { x0.cMapUrl = x1 },
      _1598: (x0,x1) => { x0.cMapPacked = x1 },
      _1599: x0 => x0.promise,
      _1600: x0 => x0.numPages,
      _1601: x0 => x0.width,
      _1602: x0 => x0.height,
      _1603: x0 => x0.promise,
      _1604: x0 => x0.random(),
      _1605: (x0,x1) => x0.getRandomValues(x1),
      _1606: () => globalThis.crypto,
      _1607: () => globalThis.Math,
      ...
      _2151: (x0,x1) => { x0.target = x1 },
      _2153: (x0,x1) => { x0.download = x1 },
      _2178: (x0,x1) => { x0.href = x1 },
      _3031: (x0,x1) => { x0.src = x1 },
      _3033: (x0,x1) => { x0.type = x1 },
      _3037: (x0,x1) => { x0.async = x1 },
      _3076: x0 => x0.width,
      _3077: (x0,x1) => { x0.width = x1 },
      _3078: x0 => x0.height,
      _3079: (x0,x1) => { x0.height = x1 },
      _3500: () => globalThis.window,
      _3541: x0 => x0.document,
      _3563: x0 => x0.navigator,
      _3952: x0 => x0.userAgent,
      _6181: () => globalThis.document,
      _6262: x0 => x0.body,
      _6264: x0 => x0.head,
      _6621: (x0,x1) => { x0.innerHTML = x1 },
      _8147: x0 => x0.result,
