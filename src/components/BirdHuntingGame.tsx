  ...
  return (
    <div className="bg-green-900/20 rounded-lg p-6 border-2 border-green-500/50">
      <div className="text-center mb-2">
        <h3 className="text-2xl font-bold text-green-300 mb-8">Bird Hunting Game</h3>
        <div className="flex justify-between items-center mb-2">
          <span className="text-white font-bold font-angry">Score: {score}</span>
      ...
      <div 
        ...
        style={{ 
          backgroundImage: 'url(/secrate/game_stage.png)'
        }}
      >
        {birds.map(bird => (
          bird.alive && (
        ...
        {!gameRunning && !gameOver && (
          <div className="absolute inset-0 flex items-center justify-center bg-black/50">
            <div className="text-center text-white">
              <p className="text-xl font-bold mb-2">Click Start to Hunt Birds!</p>
              <p className="text-sm">Click on the birds as they fly across the stage</p>
            </div>
          </div>
        )}
        ...
        {gameOver && (
          <div className="absolute inset-0 flex items-center justify-center bg-black/50">
            <div className="text-center text-white">
              ...
              <p className="text-sm">Great hunting, pig! You got {Math.floor(score / 10)} birds!</p>
            </div>
          </div>
        )}
      </div>
